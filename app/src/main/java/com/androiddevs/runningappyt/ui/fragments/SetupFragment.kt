...
class SetupFragment : Fragment(R.layout.fragment_setup) {
    ...
    private val isFirstOpen by lazy { sharedPrefs.getBoolean(KEY_FIRST_TIME_TOGGLE, true) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvContinue.setOnClickListener {
            if (writePersonalInfoToSharedPreferences()) {
    ...
    private fun writePersonalInfoToSharedPreferences(): Boolean {
